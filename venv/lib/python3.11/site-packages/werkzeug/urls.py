...
# Python < 3.12
# itms-service was worked around in previous iri_to_uri implementations, but
# we can tell Python directly that it needs to preserve the //.
if "itms-service" not in urllib.parse.uses_netloc:
    urllib.parse.uses_netloc.append("itms-service")
